<x-layouts.app>
    <x-slot name="header">
        <div class="flex gap-5 items-center" dir="rtl">
            ...
            |
            <h3>
                <a href="{{ route('admin.marketers.invoices.index', [$marketer, $customer]) }}" class=" hover:underline">
    ...
    <div class="py-12" dir="rtl">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 space-y-6">
                <form action="{{ route('admin.marketers.invoices.store', [$marketer, $customer]) }}" method="POST" class="text-right">
                    @csrf
