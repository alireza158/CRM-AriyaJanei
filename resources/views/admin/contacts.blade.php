            ...
            <table class="table table-bordered table-hover align-middle small">
                ...
                @foreach($contacts as $c)
                    <tr>
                        ...
                        <td>
                          <button class="btn btn-sm btn-outline-primary show-contact"

                            data-name="{{ $c->visitor_name }}"
                            data-city="{{ $c->city }}"
                            data-shop="{{ $c->shop_name }}"
                            data-owner="{{ $c->owner_name }}"
                                data-phone="{{ $c->owner_phone  }}"
 
                            data-address="{{ $c->address }}"
                            data-lat="{{ $c->lat }}"
                            data-lng="{{ $c->lng }}"
                            data-relation="{{ $c->relation_type }}"

                            data-activity="{{ $c->activity_field }}"
                            data-size="{{ $c->shop_size }}"
                            data-location="{{ $c->shop_location }}"
                            data-grade="{{ $c->shop_grade }}"
                            data-arya="{{ $c->arya_customer }}"
                            data-payment="{{ $c->payment_terms }}"

                            data-main_goods='@json($c->main_goods)'
                            data-nr_activity="{{ $c->nr_activity }}"
                            data-nr_goods='@json($c->nr_goods)'
                            data-nr_other="{{ $c->nr_goods_other }}"
...
@endif
                          ...
                          <button class="btn btn-sm btn-outline-danger delete-contact" data-id="{{ $c->id }}">
                            حذف
                          </button>
                        </td>
                    </tr>
