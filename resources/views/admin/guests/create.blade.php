<x-layouts.app>
    <x-slot name="header">
        <div class="flex gap-2" dir="rtl">
            ...
            <p>
                <a href="{{ route('admin.guests.index') }}">بازگشت</a>
            </p>
        </div>
        <div>
        </div>
    ...
    <div class="py-12" dir="rtl">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                <form method="POST" action="{{ route('admin.guests.store') }}" dir="rtl">
                @csrf
                @method('POST')
                    ...
                    <div class="mb-4">
                        ...
                        <input name="name" type="text" value="{{ old('name', $guest->name ?? '') }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input name="phone" type="text" value="{{ old('phone', $guest->phone ?? '') }}"
                               class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-right"
                               dir="rtl">
