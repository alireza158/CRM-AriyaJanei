<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            اطمینان حاصل کنید که حساب کاربری شما از رمز عبور طولانی و تصادفی برای امنیت استفاده می‌کند.
        </p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="update_password_password_confirmation" value="تایید رمز عبور" />
