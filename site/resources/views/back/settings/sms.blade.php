                                    ...
                                    <form id="sms-form" action="{{ route('admin.settings.sms') }}" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                ...
                                                <select id="sms-panel-provider" class="form-control" name="sms_panel_provider">
                                                    <option value="ippanel" {{ option('sms_panel_provider', 'ippanel') == 'ippanel' ? 'selected' : '' }}>
                                                        ippanel
                                                    </option>
                                                    <option value="kavenegar" {{ option('sms_panel_provider', 'ippanel') == 'kavenegar' ? 'selected' : '' }}>
                                                        کاوه نگار
                                                    </option>
                                                    <option value="melipayamak" {{ option('sms_panel_provider', 'ippanel') == 'melipayamak' ? 'selected' : '' }}>
                                                        ملی پیامک
                                                    </option>
                                                    <option value="idehpardazan" {{ option('sms_panel_provider', 'ippanel') == 'idehpardazan' ? 'selected' : '' }}>
                                                        ایده پردازان
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="row my-2 mb-4">
                                            ...
                                            <div class="form-group col-md-4">
                                                <fieldset class="checkbox">
                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                        <input data-class="detail_sms_on_order_paid" type="checkbox" name="detail_sms_on_order_paid" {{ option('detail_sms_on_order_paid') == 'on' ? 'checked' : '' }}>
                                                        <span class="vs-checkbox">
                                                            <span class="vs-checkbox--check">
                                                                <i class="vs-icon feather icon-check"></i>
                                                            </span>
                                                        </span>
                                                        <span class="">ارسال آیتم های سفارش به مدیر</span>
                                                    </div>
                                                </fieldset>
                                            </div>
                                            <div class="form-group col-md-4">
                                            ...
                                            <div class="form-group col-md-4">
                                                <fieldset class="checkbox">
                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                        <input data-class="user_sms_on_in_person_order" type="checkbox" name="user_sms_on_in_person_order" {{ option('user_sms_on_in_person_order') == 'on' ? 'checked' : '' }}>
                                                        <span class="vs-checkbox">
                                                            <span class="vs-checkbox--check">
                                                                <i class="vs-icon feather icon-check"></i>
                                                            </span>
                                                        </span>
                                                        <span class="">ارسال پیامک به کاربر برای سفارش حضوری</span>
                                                    </div>
                                                </fieldset>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <fieldset class="checkbox">
                                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                                        ...
                                                        <span class="">ارسال پیامک به کاربر موقع ثبت کد پیگیری سفارش</span>
                                                    </div>
                                                </fieldset>
                                            </div>
                                            <div class="form-group col-md-4">
